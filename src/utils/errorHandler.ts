...
export function validationHandler(error: ValidationError){

    if(error instanceof ValidationError){
        console.error(`Validation Error: ${error.message}, Error Name: ${error.name}`)
    }
}


//let's see how tax and discount be hanled
